...
import { step1Style } from "@/frontend/app/styles/step1Style";
  ...
  return (
    <>
      ...
      >
        ...
        >
          <View>
            <Text style={[step1Style.title]}>
              Your path to mindful eating starts here
            </Text>
            <Text style={[step1Style.label]}>Tell us your goals</Text>
            <Text style={[step1Style.description]}>
              Sugar-free? Budget-friendly? Vegan? We’ve got you.
            </Text>
        ...
        >
          <View>
            <Text style={step1Style.subTitle}>
              Eat smarter. {"\n"}Live better.
            </Text>
